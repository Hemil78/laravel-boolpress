...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $newCategory->save();
        //redirect
        return redirect()->route('admin.categories.index')->with('success',"Il categoria {$newCategory->id} è stata creata");
    }
    ...
    public function destroy(Request $request)
    {
        ...
        $category->delete();
        return redirect()->route('admin.categories.index')->with('success',"La categoria {$category->id} è stata eliminata");
    }
}
